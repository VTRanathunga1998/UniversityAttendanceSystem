...
<div class="modal fade" id="addLecturer" tabindex="-1" aria-labelledby="addLecturerModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-dialog-scrollable">
	<div class="modal-content">
		<div class="modal-header">
		<h5 class="modal-title" id="exampleModalLabel">Add a lecturer</h5>
		<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		</div>
		<div class="modal-body">
			<form action="addLecturer.php" method="POST" enctype="multipart/form-data" >		

				<div class="mb-3">
					<label  class="form-label">Lecturer ID</label>
					<input type="text" class="form-control" name="chooseLecID" id="" required>
				</div>
                ...
                <div class="mb-3" id="faculty_div">
					...
					<div class="frm-select" >             
						<select id="facultyDropdownAddLecturer" class="form-control" name="chooseFac" required></select>
					</div>
				</div>
				...
				<div class="mb-3" id="department_div">
					...
					<div class="frm-select" >              
						<select id="departmentDropdownAddLecturer" class="form-control" name="chooseDep"required></select>
					</div>
				</div>
                ...
                <div class="mb-3">
					...
					<input type="file" class="form-control" name="lecPic" id="lecPic" >
				</div>

				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
					<button type="submit" name="addLecturer" class="btn btn-primary">Create</button>
				</div>
